...
exports.seedManager = exports.SeedManager = void 0;
...
class SeedManager {
     ...
     * Create test organization
     */
    async createTestOrganization(adminUserId) {
     ...
     * Create test projects
     */
    async createTestProjects(organizationId, adminUserId) {
        const projects = [
            {
...
exports.seedManager = new SeedManager();
