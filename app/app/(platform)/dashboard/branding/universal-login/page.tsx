            ...
            <Card>
              <Tabs value={activeTab} onValueChange={setActiveTab}>
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    <div>
                      <CardTitle className="text-base font-semibold">Login Configuration</CardTitle>
                      <CardDescription>Customize your Universal Login experience</CardDescription>
                    </div>
                  </div>
                  ...
                  <TabsContent value="content" className="space-y-6">
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch checked={showSocialLogin} onCheckedChange={setShowSocialLogin} />
                      </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex justify-center bg-muted/50 rounded-lg p-4 overflow-hidden">
                  ...
                  >
                    <div className={cn("min-h-80 p-6 flex flex-col", currentBackground?.preview)}>
                      {logoUrl && (
                        <img
                          src={logoUrl}
                          alt="Logo"
