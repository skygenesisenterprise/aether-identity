...
export interface IdentityServerHooks {
    ...
    onUnauthorizedAttempt?: (ctx: HookContext, info: UnauthorizedInfo) => void | Promise<void>;
...
export interface ExpressResponse {
    ...
    cookie(name: string, value: string, options?: Record<string, unknown>): ExpressResponse;
